...
<font size="3"><p>Some of my recent research investigates the capability of few-shot implicit learning of tokenized language to find abstract patterns in noisy social media data. This has uncovered fascinating empirical evidence that abstract patterns in online communication are geospatially influenced. It also demonstrates that low-level linear models are capable of capturing subtle correlations in the aggregate.
</p>
